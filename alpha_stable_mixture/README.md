Here’s a modernized and expanded version of your `README.md`, designed to be more polished, detailed, and appealing to both researchers and practitioners working with alpha-stable distributions:
